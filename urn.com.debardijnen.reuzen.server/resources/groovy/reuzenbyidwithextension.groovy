...
INKFRequest reuzenbyidrequest = aContext.createRequest("active:reuzenbyid");
reuzenbyidrequest.addArgumentByValue("owner", aOwner);
reuzenbyidrequest.addArgumentByValue("id", aID);
