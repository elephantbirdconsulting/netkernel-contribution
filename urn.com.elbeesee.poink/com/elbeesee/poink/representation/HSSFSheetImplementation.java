...
/**
 *
 * Representation Implementation for HSSFSheet.
 * 
...
public class HSSFSheetImplementation implements IHSSFSheetRepresentation {
	
	private HSSFSheet mSheet;
	
	public HSSFSheetImplementation (HSSFSheet aSheet) {
		this.mSheet = aSheet;
	}
	...
	public HSSFSheet getSheetReadOnly () {
		return mSheet;
	}
}
