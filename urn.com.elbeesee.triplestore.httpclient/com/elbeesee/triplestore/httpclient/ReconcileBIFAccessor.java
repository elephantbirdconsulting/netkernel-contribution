...
public class ReconcileBIFAccessor extends StandardAccessorImpl {
	public ReconcileBIFAccessor() {
	...
	public void onSource(INKFRequestContext aContext) throws Exception {
		...
		reconcilequery.addArgument("operator", "res:/resources/freemarker/reconcilebif.freemarker");
		...
		xsltcrequest.addArgument("operator", "res:/resources/xsl/sparqlresult_to_json_bif.xsl");
