...
public class ReconcileAccessor extends StandardAccessorImpl {
	public ReconcileAccessor() {
	...
	public void onSource(INKFRequestContext aContext) throws Exception {
		...
		reconcilequery.addArgument("operator", "res:/resources/freemarker/reconcile.freemarker");
		...
		stardogsparqlrequest.addArgumentByValue("query",vQuery);
		stardogsparqlrequest.addArgumentByValue("accept", "application/sparql-results+xml");
		stardogsparqlrequest.addArgumentByValue("expiry", aExpiry);
		stardogsparqlrequest.addArgumentByValue("credentials", aCredentials);
		Object vSparqlResult = aContext.issueRequest(stardogsparqlrequest);
